...
\begin{center}
   \normalsize Fonte: Autor (própria). Ver comentários %na Figura 26.
    \end{center}
\label{fig:sbmt-moses}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.8\textwidth]{figuras/vetorpop.jpg}
   	\begin{center}
        \normalsize Fonte: Autor (própria). Predominância %das populações na amostra selecionada da Categoria 7.
    \end{center}
	\label{fig:sbmt-moses}
\end{figure}
